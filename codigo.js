var fila = "<tr><td class='id'></td><td class='foto'></td><td class='price'></td><td class='title'></td><td class='description'></td><td class='category'></td><td><button type='submit' class='editar btn btn-warning mb-2'>Editar</button><button type='submit' class='eliminar btn btn-danger'>Eliminar</button></td></tr>";
var productos = null;
...
function obtenerProductos() {
	fetch('https://retoolapi.dev/J3Exaq/productos')
		.then(res => res.json())
		.then(data => { 
			productos = data; 
			productos.forEach(
